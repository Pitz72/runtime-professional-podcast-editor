    ...
    <div className="flex items-center justify-center h-full bg-gray-900">
      <div className="text-center p-12 bg-gray-800 rounded-2xl shadow-2xl border border-gray-700 max-w-2xl">
        ...
        <h2 className="text-3xl font-light text-purple-400 mb-6">
          Podcast Creation Kit
        </h2>
        <p className="text-gray-400 mb-8 max-w-lg mx-auto">
          This is an audio editing application designed to build podcasts. It allows you to compose your show from music, background ambience, voice tracks, and sound effects, with AI-powered features to achieve a professional sound with ease.
        </p>
