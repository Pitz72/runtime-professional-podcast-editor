      ...
      try {
        ...
        switch (chunk) {
          ...
          case 'audio-engine':
            ...
            break;
          case 'effects':
            await import('../types'); // Types are lightweight
            break;
        }
  ...
  const preloadChunk = useCallback(async (chunkName: string): Promise<void> => {
    ...
    try {
      switch (chunkName) {
        ...
        // Effects chunk
        case 'effects':
          await import('../types'); // Effects types
          break;
        case 'equalizer':
          await import('../types'); // EQ types
          break;
        case 'compressor':
          await import('../types'); // Compressor types
          break;

        // Export chunk
        case 'export':
          await import('../components/TransportControls');
          break;
        case 'wav-encoder':
