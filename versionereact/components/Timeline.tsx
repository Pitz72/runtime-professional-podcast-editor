...
import { Project, Track, AudioFile, TrackKind, AudioClip, TimelineHandle } from '../types';
...
const Timeline = forwardRef<TimelineHandle, TimelineProps>(({ project, setProject, selectedItem, onSelectItem, onAddTrack, onDeleteTrack, currentTime, onSeek, isPlaying, pixelsPerSecond, zoomIndex, onZoomChange }, ref) => {
